...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/menaloho',
    color: '#e1306c',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/MenAloho',
    color: '#1877f2',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
  ...
  {
    name: 'Spotify',
    href: 'https://open.spotify.com/artist/3elVp9RS2s3wh9ao7x3Xsg',
    color: '#1db954',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
    ...
    <footer className="footer">
      ...
      <div className="footer__bottom">
        <p className="footer__copy">
          © {new Date().getFullYear()} Men Aloho. All rights reserved.
        </p>
